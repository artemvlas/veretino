...
QString suffix(const QString &file);                                          // "file.txt" --> "txt"
QString setSuffix(const QString &file, const QString &suf);                   // "file" or "file.txt" --> "file.zip"
int suffixSize(const QString &file);                                          // "/folder/file.txt" --> 3
